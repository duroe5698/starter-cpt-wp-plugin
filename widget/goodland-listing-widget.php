...
//* Goodland listing widget for home page

class GoodlandListingWidget extends WP_Widget
{
  function GoodlandListingWidget()
  {
    $widget_ops = array('classname' => 'GoodlandListingWidget', 'description' => 'Display Goodland listing on home page.' );
    parent::__construct('GoodlandListingWidget', 'Goodland Listing Widget', $widget_ops);
  }
...
<?php
  ...
  global $post;
        $args = array(
            ...
            'categories' => 'goodland-residential',
            'post_status' => 'publish',
            'posts_per_page' => 1,
            'orderby' => 'rand',
            'order' => 'DSC',
    ...
    if ( $wp_query->have_posts() ) : while ( $wp_query->have_posts() ) :  $wp_query->the_post();
            ...
            echo '<a class="pl-loc-widget-listings-link" href="/categories/goodland-residential/">See All Goodland Listings</a>';
...
add_action( 'widgets_init', create_function('', 'return register_widget("GoodlandListingWidget");') );