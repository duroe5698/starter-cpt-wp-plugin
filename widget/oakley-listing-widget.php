...
//* Oakley listing widget for home page

class OakleyListingWidget extends WP_Widget
{
  function OakleyListingWidget()
  {
    $widget_ops = array('classname' => 'OakleyListingWidget', 'description' => 'Display Oakley listing on home page.' );
    parent::__construct('OakleyListingWidget', 'Oakley Listing Widget', $widget_ops);
  }
...
<?php
  ...
  global $post;
    ...
    if ( $wp_query->have_posts() ) : while ( $wp_query->have_posts() ) :  $wp_query->the_post();
            ...
            echo '<a class="pl-loc-widget-listings-link" href="/categories/oakley-residential/">See All Oakley Listings</a>';
...
add_action( 'widgets_init', create_function('', 'return register_widget("OakleyListingWidget");') );