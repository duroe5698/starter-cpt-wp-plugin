...
//* Area listing widget for home page

class AreaListingWidget extends WP_Widget
{
  function AreaListingWidget()
  {
    $widget_ops = array('classname' => 'AreaListingWidget', 'description' => 'Display Area listing on home page.' );
    parent::__construct('AreaListingWidget', 'Area Listing Widget', $widget_ops);
  }
...
<?php
  ...
  global $post;
    ...
    if ( $wp_query->have_posts() ) : while ( $wp_query->have_posts() ) :  $wp_query->the_post();
            ...
            echo '<a class="pl-loc-widget-listings-link" href="/categories/area-listings/">See All Area Listings</a>';
...
add_action( 'widgets_init', create_function('', 'return register_widget("AreaListingWidget");') );