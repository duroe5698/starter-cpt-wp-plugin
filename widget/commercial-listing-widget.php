...
//* Commercial listing widget for home page

class CommercialListingWidget extends WP_Widget
{
  function CommercialListingWidget()
  {
    $widget_ops = array('classname' => 'CommercialListingWidget', 'description' => 'Display Commercial listing on home page.' );
    parent::__construct('CommercialListingWidget', 'Commercial Listing Widget', $widget_ops);
  }
...
<?php
  ...
  global $post;
    ...
    if ( $wp_query->have_posts() ) : while ( $wp_query->have_posts() ) :  $wp_query->the_post();
            ...
            echo '<a class="pl-loc-widget-listings-link" href="/categories/commercial/">See All Commercial Listings</a>';
...
add_action( 'widgets_init', create_function('', 'return register_widget("CommercialListingWidget");') );