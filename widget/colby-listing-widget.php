...
//* Cobly listing widget for home page

class ColbyListingWidget extends WP_Widget
{
  function ColbyListingWidget()
  {
    $widget_ops = array('classname' => 'ColbyListingWidget', 'description' => 'Display Colby listing on home page.' );
    parent::__construct('ColbyListingWidget', 'Colby Listing Widget', $widget_ops);
  }
...
<?php
  ...
  global $post;
    ...
    if ( $wp_query->have_posts() ) : while ( $wp_query->have_posts() ) :  $wp_query->the_post();
            ...
            echo '<a class="pl-loc-widget-listings-link" href="/categories/colby-residential/">See All Colby Listings</a>';
...
add_action( 'widgets_init', create_function('', 'return register_widget("ColbyListingWidget");') );